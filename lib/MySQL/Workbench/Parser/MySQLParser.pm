package MySQL::Workbench::Parser::MySQLParser;

=head1 NAME

MySQL::Workbench::Parser::MySQLParser

a modified version of

SQL::Translator::Parser::MySQL

a pull request with the changes are created, but we do not know when it/if this
will be merged.
...
sub parse {
    ...
    my $parser = Parse::RecDescent->new($MySQL::Workbench::Parser::MySQLParser::GRAMMAR);
...
This module will be removed when the necessary changes are merged into
SQL::Translator
...
Renee Baecker E<lt>reb@perl-services.deE<gt>,
